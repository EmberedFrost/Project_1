...
class MCSimulation:
    ...
    # Describe the final cumulative returns
    ...
    result_df["Final Cumulative Returns"] = metrics

    # Add confidence interval values
    result_df.loc["95% CI Lower", "Final Cumulative Returns"] = self.confidence_interval[0.025]
    result_df.loc["95% CI Upper", "Final Cumulative Returns"] = self.confidence_interval[0.975]
